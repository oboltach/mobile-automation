...
//  CI-friendly env defaults. They allow your framework to run reliably on CI with different simulators, versions, and app paths.
...
// UDID is optional; don't set it on CI unless you know it
...
export const config = {
    ...
    capabilities: [
      ...
      },
      {
        ...
        'appium:automationName': 'XCUITest',
        'appium:platformVersion': IOS_VERSION,
        'appium:deviceName': process.env.IOS_DEVICE_2 || 'iPhone 16 Plus',
        'appium:app': IOS_APP,
        ...(process.env.IOS_UDID_2 ? { 'appium:udid': process.env.IOS_UDID_2 } : {}),
        'appium:newCommandTimeout': 240,
        'appium:autoAcceptAlerts': true,
    ...
    services: [['appium', {
      args: {
        ...
        // leave basePath default '/' since service starts it; align CI accordingly
        // basePath: '/wd/hub'
      }
    }]],
    ...
    reporters: [
    'spec',   // (optional, keep for console logs)
    ['allure', {
